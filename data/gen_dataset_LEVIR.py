...
def read_GZ(root_path, in_name):
    ...
    label = cv2.imread(root_path + '/label/' + in_name)
...
crop_w = 256  # 裁剪图像宽度
crop_h = 256  # 裁剪图像高度
root_path = '/data/project_frb/dataset/CD_DA_building/LEVIR_CD/'
# root_path = './'

dataset_name = 'LEVIR_CDPatch'
...
filename = open(root_path+'train.txt', 'w')
