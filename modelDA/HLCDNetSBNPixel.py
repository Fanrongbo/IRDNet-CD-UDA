...
class DeepDeconv(nn.Module):
    def __init__(self, num_domains_bn=2):
        ...
        self.deconv_1 = nn.Sequential(
            ...
            # nn.BatchNorm2d(128),
            BatchNormDomain(64, self.num_domains_bn, nn.BatchNorm2d),
            nn.ReLU(),
        ...
        self.deconv_2 = nn.Sequential(
            ...
            nn.ReLU(),
            BasicBlock(32, 32, num_domains_bn=self.num_domains_bn),
        ...
        self.deconv_3 = nn.Sequential(
            ...
            nn.PixelShuffle(upscale_factor=2),
            # nn.BatchNorm2d(64),
            BatchNormDomain(24, num_domains_bn, nn.BatchNorm2d),
            nn.ReLU(),
            # BasicBlock(64, 64),
            BasicBlock(24, 24, num_domains_bn=self.num_domains_bn),
...
class CD_classifer(nn.Module):
    def __init__(self,num_domains_bn):
        ...
        self.deconv_classier = nn.Sequential(
            nn.Conv2d(in_channels=24, out_channels=2, kernel_size=3, padding=1),
        )
