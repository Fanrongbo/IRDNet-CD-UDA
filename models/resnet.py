...
def _resnet2l(
    ...
    **kwargs: Any,
    ...
    model = ResNet2l(block, layers, **kwargs)
    if pretrained:
        # state_dict = load_state_dict_from_url(model_urls[arch], progress=progress)
        # model.load_state_dict(state_dict)
        ...
        # model.state_dict().update(part_sd)
    return model
...
def resnet34_2l(pretrained: bool = False, progress: bool = True, **kwargs: Any) -> ResNet:

    return _resnet2l("resnet34", BasicBlock, [3, 4, 6, 3], pretrained, progress, **kwargs)
